...
if (!empty($_POST)) {
    ...
    if ($stmt->rowCount()) {
        ...
        $stmt = $db->prepare("insert into consumer_user (email, fullname, city, district, address, Flag, Auth_Code, token, password) values ( ?, ?, ?, ?, ?, 1, $rand,1, ?)");
...
<div class="container">
    ...
    <form action="?" method="post"  class="slide-in-bottom">
        <table id="main">
            ...
            <tr>
                <td colspan="2" style="text-align: center;"><button>Login</button></td>
            </tr>
        </table>
    </form>
