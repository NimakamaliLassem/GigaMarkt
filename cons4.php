...
if (isset($buy)) {
    foreach ($cart as $p) {
        $db->prepare("delete * from products where img_name = '$p'")
            ->execute();
    }
    $_SESSION['cart'] = array();
}
...
<div id="head">
    ...
    <div id="carts">
        <form action="?" method="post">
            ...
            echo "<h1>Discounted PRICE: $discounted </h1>";
        ...
        $("#select td").click(function() {
            ...
            switch (x) {
                case 'list':
                    ...
                    $("#body").html("<?php echo "<h2>List of Items</h2>";
                                            $showProfile = false; ?>");
                ...
                case 'out':
                    ...
                    $("#body").html(
                        "<?php echo "<a href='logout.php'><h2>Exit</h2></a>";
                                $showProfile = false; ?>"
                    );
                    $("#profileData").css("display", "none");
                    $("#warning").css("display", "none");
