...
// auto login (homework)
if (validSessionCons()) {
    $db->query("update consumer_user set Auth_Code = 1 where email=$email");
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="custom_menu">
                        <h1 class="fashion_taital"  style=" font-family: 'Roboto', sans-serif;">GigaMarkt&trade;</h1><h3  class="fashion_taital"  style="font-size:large; font-family: 'Roboto', sans-serif;">Customer</h3>
                     </div>
                  </div>
               </div>
            </div>
            ...
            if (!empty($_POST)) {
                ...
                if (checkUserCons($email, $pass)) {
                    ...
                    if ($userData["Flag"] == false) {
                        header("Location: mail2.php?email=$email");
                    }
                    else{
            
                        header("Location: cons.php?email=$email");
